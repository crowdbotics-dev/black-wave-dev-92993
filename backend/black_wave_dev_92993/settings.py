"""
Django settings for black_wave_dev_92993 project.
...
ROOT_URLCONF = 'black_wave_dev_92993.urls'
...
WSGI_APPLICATION = 'black_wave_dev_92993.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "black_wave_dev_92993 API",
    "DESCRIPTION": "API documentation for black_wave_dev_92993 App",
    "VERSION": "v1",
}
